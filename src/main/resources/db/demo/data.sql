INSERT INTO user (id, username, nickname, full_name, status, created_at, balance, role) VALUES
    ...
    (4, 'venueadmin1', '一号场馆管理员', '一号场馆管理员', 1, CURRENT_TIMESTAMP, 0, 'VENUE_ADMIN'),
    (5, 'venueadmin2', '二号场馆管理员', '二号场馆管理员', 1, CURRENT_TIMESTAMP, 0, 'VENUE_ADMIN');
...
INSERT INTO user_auth (id, user_id, identity_type, identifier, credential, last_login_at, created_at, updated_at) VALUES
    ...
    (4, 4, 'username', 'venueadmin1', '$2a$10$sqFCNyKfS1jE7.Wi43rObOluwQgyCJUA9UTMkb7jeIXTM9M5fsuL6', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (5, 5, 'username', 'venueadmin2', '$2a$10$sqFCNyKfS1jE7.Wi43rObOluwQgyCJUA9UTMkb7jeIXTM9M5fsuL6', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO venue_admin (id, user_id, venue_id) VALUES
    (1, 4, 1),
    (2, 4, 4),
    (3, 5, 2),
    (4, 5, 3);
